  ...
  return (
    <section className="relative z-10 py-28 sm:py-36">
      <div className="mx-auto max-w-7xl px-6">
        <SectionHeading eyebrow="Sample perspectives" title={<>Built for the work behind <span className="gradient-text">being found.</span></>} subtitle="Illustrative testimonials for the approved demo. Replace with verified customer reviews before public launch." />
      </div>
